...
class UserController extends Controller
{
    ...
    public function index()
    {
        ...
        */
        ...
        return view('back/organization/user/index', compact('users', 'user', 'organization'));
    }
    ...
    public function create()
    {
        ...
        */
        ...
        $roles = DB::table('roles')->whereIn('name', ['organization-user', 'group-admin'])->get();

        return view('back/organization/user/create', compact('organization', 'documents', 'countries', 'incomes', 'maritals', 'genders', 'residents', 'roles', 'user'));
    }

    public function downloadCsvTemplate()
    {
        $path = base_path() . '/public/templates/users_onboarding.csv';
    ...
    public function store(UserRequest $request)
    {
       ...
       // dd($user);
        ...
        $orguser->country = $request->country_id;
    ...
    public function show($id)
    {
        ...
        $currency = DB::table('currencies')
                    ->where('country_id', '=', $detail->country)
                    ->first();
        ...
        return view('back/organization/user/show', compact('user', 'detail', 'country', 'document', 'countries', 'documents', 'owned', 'transactions', 'membergroups','incomes', 'maritals', 'genders', 'residents', 'gender', 'income', 'residence', 'currency'));
    }
    ...
    public function importUsers(Request $request)
    {
        ...
        $userImport->createUsers($header, $rows, $request->org_id);
        Session::flash('success', 'Users successfully imported into your organization');
        return redirect()->route('users.index');
    }
