...
class ServiceController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('back/serviceprovider/service/index', compact('services', 'user'));
    }
    ...
    public function create()
    {
        ...
        return view('back/serviceprovider/service/create', compact('services', 'user'));
    }
    ...
    public function show($id)
    {
        ...
        return view('back/serviceprovider/service/show', compact('service', 'user'));
    }
