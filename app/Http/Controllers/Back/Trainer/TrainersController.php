...
class TrainersController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('back/federation/trainer/index', compact('users'));
    }
    ...
    public function create()
    {
        ...
        return view('back/federation/trainer/create', compact('organization', 'documents', 'countries', 'incomes', 'maritals', 'genders', 'residents', 'trainers'));
    }
