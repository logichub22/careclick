...
class UserCoopBankController extends Controller
{
    protected $CK;
    protected $keys;
    public $action;
    ...
    {
        $user = Auth::user();
        return view('back/individual/coopbank/index', compact('user'));
    }
    ...
    public function checkBalance($requestData, $token) {
        ...
        $user = Auth::user();
        return view('back/individual/coopbank/basic', compact('user', 'page', 'responseObj'));
    }
    ...
    public function transactions($requestData, $token) {
        ...
        $user = Auth::user();
        return view('back/individual/coopbank/transactions', compact('user', 'page', 'responseObj'));
    }
