...
class PageController extends Controller
{
    public function getDashboard()
    {
        ...
        $latest = DB::table('users')
                    ...
                    ->take(5)
                    ->get();
        $organization = DB::table('organizations')->where('admin_id', $admin)->first();

        $associations = DB::table('organizations')->where('federation', $organization->id)->get();
        ...
        $groups = DB::table('groups')->whereIn('association_id', $ids)->get();

        $wallet = OrganizationWallet::where('org_id', $organization->id)->first();
    	return view('back/federation/pages/dashboard', compact('user', 'users', 'latest', 'wallet', 'associations', 'groups'));
    }
    ...
    public function manageProfile()
    {
    	...
    	return view('back/federation/pages/profile', compact('organization', 'user'));
    }
    ...
    public function accessLogs(Request $request)
    {
       ...
       // dd($logs);
        ...
        return view('back/federation/pages/logs', compact('logs'));
    }
    ...
    public function getLedger(Request $request)
    {
        ...
        //dd($debits);
        return view('back/federation/transaction/ledger', compact('transactions', 'credits', 'debits'));
    }
