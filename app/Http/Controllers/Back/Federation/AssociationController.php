...
class AssociationController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('back/federation/association/index', compact('organizations', 'user'));
    }
    ...
    public function show($id)
    {
        ...
        return view('back/federation/association/show', compact('organization', 'user', 'members', 'groups'));
    }
