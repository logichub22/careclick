  ...
  var myChart = new Chart(ctx, {
    ...
    data: {
      ...
      datasets: [{
        ...
        pointRadius: 3,
        pointBorderColor: 'transparent',
        pointBackgroundColor: '#d6520b',
      }, {
        label: "Loans Borrowed",
        data: [0, 100, 30, 10, 70, 9, 12],
        backgroundColor: 'transparent',
        borderColor: '#d6260b',
        borderWidth: 2,
        pointStyle: 'circle',
        pointRadius: 3,
        pointBorderColor: 'transparent',
        pointBackgroundColor: '#d6260b',
      }, {
        label: "Loans Lend Out",
        data: [0, 0, 40, 10, 60, 9, 70],
        backgroundColor: 'transparent',
        borderColor: '#2271bf',
        borderWidth: 2,
        pointStyle: 'circle',
