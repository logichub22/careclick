    ...
    columns.forEach(function (column, i) {
      return column.forEach(function (el, j) {
        if (j === 0) {
          ...
          translates[i][j] = rowHeights[j - 1] - columns[i][j - 1].offsetHeight + translates[i].reduce(function (sum, op) {
            return sum + op;
          }, 0);
        }
      });
  ...
  var Switcher = {
    ...
    methods: {
      index: function index() {
        return _index(children(this.connects[0], "." + this.cls)[0]);
      },
...
module.exports = __webpack_require__(/*! C:\Users\DaAef\Projects\jamborow\src\assets\js\app.js */"./src/assets/js/app.js");
