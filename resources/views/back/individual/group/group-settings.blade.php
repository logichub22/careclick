			...
			<div class="card">
				<div class="card-body">
					<ul class="nav nav-4">
						...
						<li class="nav-item">
							<a class="nav-link" href="{{ route('user-groups.show', $group->id) }}">
								<i class="fas fa-tachometer-alt"></i> Back to group portal
							</a>
						</li>
						<li class="nav-item">
							<a class="nav-link" href="{{ route('usergroup.addmember', $group->id) }}">
	...
	<!-- <div class="row"> -->
		<div class="col-md-8">
			<div class="card">
				...
				<div class="card-body">
					<form action="{{ route('usergroup.contributions-settings') }}" method="POST">
						{{ csrf_field() }}
						<input type="hidden" name="group" value="{{ $group->id }}">
						<div class="row">
							<div class="col-md-6">
								<div class="form-group">
									...
									<input type="text" class="form-control" placeholder="Enter Contribution Amount" name="amount">
								</div>
							</div>
							<div class="col-md-6">
								<div class="form-group">
