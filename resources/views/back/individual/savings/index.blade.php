            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="card-header-action">
                        <a href="{{ route('savings-add-money') }}" class="btn btn-danger btn-icon icon-right">Deposit to Savings<i class="fas fa-chevron-right"></i></a>
                    </div>
                </div>
                <div class="card-body">
        ...
        <div class="col-md-6 col-12">
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="card-header-action">
                        <a href="{{ route('savings-transfer') }}" class="btn btn-danger btn-icon icon-right">Transfer to Main Wallet<i class="fas fa-chevron-right"></i></a>
                    </div>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
