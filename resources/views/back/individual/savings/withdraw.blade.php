		...
		<div class="col-md-12">
			<div class="card col-md-3">
				<div class="card-body">
					<div class="row">
						<div class="col-md-12">
							<a href="{{ route('usersavings') }}" class="btn btn-primary btn-block">Back to savings</a>
						</div>
					</div>
				</div>
			</div>
			<div class="card">
				...
				<div class="card-body">
					<form id="withdrawFunds" method="POST" action="{{ route('user-savings-transfer') }}">
					{{ csrf_field() }}
					<div class="row">
						<div class="col-md-6">
						...
						<div class="col-md-6">
							<div class="form-group">
								<label for="wallet_balance">Available Balance</label>
								<input type="text" class="form-control" name="balance" placeholder="NGN {{ number_format($available_balance) }}" id="balance" disabled="">
							</div>
						</div>
					</div>
					<div class="row">
