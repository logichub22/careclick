...
@section('page-nav')
	...
	<ol class="breadcrumb no-bg mb-1">
		...
		<li class="breadcrumb-item"><a href="{{ route('organization.browseloans') }}">Available Loans</a></li>
		<li class="breadcrumb-item active">Apply for a loan</li>
	</ol>
@endsection
			...
			<div class="box box-block bg-white">
				...
				<div class="row">
					<div class="col-md-4">
						...
						<p>{{ number_format($package->min_amount) . ' ' . $package->currency }}</p>
					</div>	
					<div class="col-md-4">
						<p><i class="far fa-money-bill-alt"></i> Max Amount</p>
						<p>{{ number_format($package->max_amount) . ' ' . $package->currency }}</p>
					</div>
					<div class="col-md-4">
