		...
		<div class="col-sm-4 col-md-3">
			...
			<div class="box bg-white">
				<ul class="nav nav-4">
					...
					<li class="nav-item">
						<a class="nav-link" href="">
							<i class="fa fa-user"></i>Members 0
						</a>
					</li>
					<li class="nav-item" title="Create multiple group member accounts by importing a csv file">
						<a class="nav-link" href="#importMembers" data-toggle="modal" id="clickable">
						...
						<tbody>
							@foreach($members as $member)
								<tr>
									...
									<td>
										<a href="{{ route('group.viewmember', $member->memberid) }}" class="btn btn-sm btn-primary" title="View User"><i class="far fa-eye"></i></a> &nbsp;
									</td>
								</tr>
							@endforeach
						</tbody>
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<form action="{{ route('groupmembers.import') }}" method="POST" enctype="multipart/form-data">
					...
					<input type="hidden" name="grp_id" value="{{ $group->id }}">
