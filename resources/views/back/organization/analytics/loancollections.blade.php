...
@section('content')
    ...
    <div class="row">
        <div class="w-100">
            <div class="card">
                <div class="card-header">
                    <h4>@lang('individual.transactioncollections')</h4>
                </div>
                <div class="card-body">
...
@section('spec-scripts')
    ...
    <!-- <script src="{{ asset('assets/js/page/loan-collections.js') }}"></script> -->
    ...
    <script type="text/javascript">
        var loan_pending = {!! json_encode($loan_pending) !!};
        var loan_pending = Object.values(loan_pending);

        var loan_paid = {!! json_encode($loan_paid) !!};
        var loan_paid = Object.values(loan_paid);

        var loan_defaulted = {!! json_encode($loan_defaulted) !!};
        var loan_defaulted = Object.values(loan_defaulted);
