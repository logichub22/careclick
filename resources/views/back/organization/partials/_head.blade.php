...
<!-- Styles -->
<link rel="stylesheet" href="{{ asset('css/back/theme.css') }}">
<link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.2.0/css/all.css" integrity="sha384-hWVjflwFxL6sNzntih27bfxkr27PmbbK/iSvJ+a4+0owXq79v+lsFkW54bOGbiDQ" crossorigin="anonymous">
<link rel="stylesheet" href="{{ asset('css/main/animate.css') }}">
<link rel="stylesheet" href="{{ asset('plugins/themify-icons/themify-icons.css') }}">
<link rel="stylesheet" href="{{ asset('plugins/jscrollpane/jquery.jscrollpane.css') }}">
<link rel="stylesheet" href="{{ asset('plugins/chartist/chartist.min.css') }}">
<link rel="stylesheet" href="{{ asset('plugins/waves/waves.min.css') }}">
<link rel="stylesheet" href="{{ asset('plugins/switchery/dist/switchery.min.css') }}">
...
<link rel="stylesheet" href="{{ asset('css/back/neptune.css') }}">
<link rel="stylesheet" href="{{ asset('css/main/jamborow.css') }}">
<link rel="stylesheet" href="{{ asset('css/back/back.css') }}">
