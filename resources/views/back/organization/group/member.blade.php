						...
						<div class="col-sm-12 col-md-6">
							@if($user->memberstatus)
						 		...
						 		{!! Form::open(['route' => ['cancelmember', $user->memberid],'method' => 'POST', 'style' => 'display: inline-block', 'id' => 'cancelForm']) !!}  
	                               ...
	                               {!! Form::button('Cancel Membership', array('id'=> 'cancel', 'type' => 'submit', 'class' => 'btn btn-block btn-warning', 'title' => 'Cancel Membership')) !!}
	                            {!! Form::close() !!}
							@else
								{!! Form::open(['route' => ['renewmember', $user->memberid],'method' => 'POST', 'style' => 'display: inline-block', 'id' => 'renewForm']) !!} 
								   <input type="hidden" name="group" value="{{ $group->name }}">   
						 		   <input type="hidden" value="{{ $user->name }}" name="member_name">
								   <input type="hidden" value="{{ $user->email }}" name="email">                               
	                               {{Form::button('Renew Membership', array('id'=> 'renew', 'type' => 'submit', 'class' => 'btn btn-block btn-primary', 'title' => 'Renew Membership'))}}
	                            {!! Form::close() !!}
							@endif
						</div>
						<div class="col-sm-12 col-md-6">
							{!! Form::open(['route' => ['deletemember', $user->memberid],'method' => 'POST', 'style' => 'display: inline-block', 'id' => 'deleteForm']) !!}  
	                           ...
	                           {{Form::button('Delete From Group', array('id' => 'delete', 'type' => 'submit', 'class' => 'btn btn-block btn-danger', 'title' => 'Cancel Membership'))}}
	                        {!! Form::close() !!}
						</div>
					</div>
				</div>
